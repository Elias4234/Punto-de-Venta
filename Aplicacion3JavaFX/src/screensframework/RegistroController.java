...
public class RegistroController implements Initializable, ControlledScreen {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        /* El error es que la o esta en mayusecula y la solucion es ponerla en minuscula */
    ...
    private void registroUsuario(ActionEvent event){
        ...
        try {
            conexion = DBConnection.connect();
/* El error es que dice usuario y email que esta mal y la solucion es que diga usuarios y correo */
